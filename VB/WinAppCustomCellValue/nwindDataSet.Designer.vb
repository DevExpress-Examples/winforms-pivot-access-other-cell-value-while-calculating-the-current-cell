...
Namespace WinAppCustomCellValue
    ...
    Partial Public Class nwindDataSet
        ...
        Partial Public Class SalesPersonDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddSalesPersonRow(ByVal Country As String, ByVal CategoryName As String, ByVal Extended_Price As Decimal) As SalesPersonRow
                Dim rowSalesPersonRow As SalesPersonRow = (DirectCast(Me.NewRow(), SalesPersonRow))
                Dim columnValuesArray() As Object = { Country, CategoryName, Extended_Price}
...
Namespace WinAppCustomCellValue.nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Country, CategoryName, [Extended Price] FROM SalesPerson"
